...
const systemMethodContext: Record<string, Record<string, string>> = {
  ...
  "f2r-system": {
    ...
    QM002: "Explains the time-ordered estimation design used by F2R's conventional supervised models; Chronos-2 is evaluated through a separate inference path rather than sharing the same fitting window.",
    ...
    QM027: "Explains the rank-to-portfolio translation used after heterogeneous forecasts enter a common rank-based process, including Top-K selection, persistence, and the distinction between ranks and portfolio weights.",
  ...
  "pds-system": {
    ...
    QM009: "Defines turnover and transaction-cost conventions used when implementation effects are evaluated across portfolio decisions.",
    QM011: "Provides strategy-similarity and decision-diversification concepts used when PDS evaluates whether a provider adds useful diversification before admission.",
    ...
    QM014: "Defines information-timing and data-availability discipline for provider inputs that depend on macroeconomic information.",
  ...
  "equity-alpha-system": {
    ...
    QM026: "Defines point-in-time dynamic-universe construction, including listing history, liquidity/history gates, survivorship control, exposure deduplication, and controlled expansion of the model-ready candidate pool.",
    ...
    QM024: "Explains how heterogeneous predictive views can be combined in a common rank-based process without confusing raw forecast scales, normalized rank strength, and downstream portfolio weights.",
...
export const quantitativeMethods: QuantitativeMethod[] = [
  ...
  },
  {
    ...
    researchContext:
      "Explains how an investable universe can evolve through time without survivorship bias, including listing history, eligibility gates, exposure deduplication, representative selection, and controlled candidate-pool expansion.",
  },
  {
    id: "QM027",
