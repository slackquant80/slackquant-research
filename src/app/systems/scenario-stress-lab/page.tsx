      ...
      <section className="paper-hero system-hero">
        <div className="shell">
          ...
          <div className="actions">
            <a className="btn primary ext" href={item.links.ssrn} target="_blank" rel="noopener noreferrer">
              Open SSRN White Paper
            </a>
      ...
      <div className="shell detail-layout system-detail-layout">
        ...
        <article>
          <section className="prose-section" id="overview">
            <h2>Overview</h2>
            <p className="lede">
              The Multi-Asset Scenario Stress Lab is a human-in-the-loop operational
              research system for 20-trading-day multi-asset stress analysis. It
              generates conditional joint return paths for eight liquid ETFs,
              organizes adverse scenarios into transparent stress archetypes,
              compares those scenarios with historical block-bootstrap resampling,
              and revalues portfolios on a common scenario cloud.
            </p>
            <div className="metrics system-metrics">
              <div className="metric"><div className="value">8</div><div className="label">ETFs in the scenario universe</div></div>
            ...
            <div className="evidence-note">
              The system is not a crash-prediction engine, trading signal, automatic
              allocation rule, or calibrated crisis-probability estimator.
            </div>
          </section>
          ...
          <section className="prose-section" id="evidence-position">
            ...
            <p className="body-copy">
              The primary out-of-sample evaluation used 348 fixed forecast origins
              from 2019 through 2025. B1 EWMA-t remained the reference model. Flow F1
              remained competitive and faster than the higher-step Flow reference,
              but the evidence did not establish predictive superiority for a modern
              generative model over B1.
            </p>
            ...
            <div className="evidence-note">
              The Stage A–E decision-value program is explicitly retrospective because
              it reuses the 2019–2025 interval already examined in the primary OOS
              evaluation. Stage D qualifies one bounded product use; it is not a new
              independent OOS strategy test.
            </div>
          </section>
          ...
          <section className="prose-section" id="contract">
            ...
            <div className="system-role-grid">
              <div className="system-role-card">
                ...
                <h3>B1 EWMA-t</h3>
                <p>
                  Uses eligible return history through the forecast origin to estimate
                  a mean and exponentially weighted covariance matrix, then generates
                  heavy-tailed multivariate Student-t innovations.
                </p>
              </div>
              <div className="system-role-card">
                ...
                <p>
                  Resamples contiguous 20-day historical blocks without conditioning
                  on the current state. It remains visible as the transparent reference.
                </p>
              </div>
              <div className="system-role-card">
                ...
                <h3>Flow F1</h3>
                <p>
                  Retained for research comparison only. No public operational warning,
                  switch, blend, or confidence badge depends on Flow.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="prose-section" id="evidence">
            ...
            <p className="body-copy">
              The retained Stage-D use asks whether the adverse scenario cloud contains
              a stable and externally relevant representation of the joint stress pattern
              that subsequently occurred. On 56 fixed large-drawdown origins, B1 placed
              more tail mass on the realized archetype and produced closer representative
              stress geometry than B0.
            </p>
            ...
            <div className="selected-table-block">
              ...
              <div className="evidence-table-wrap">
                <table className="evidence-table system-evidence-table">
                  <thead>
                    <tr>
                      <th>Method</th><th>D1 share</th><th>D2 top-2</th><th>D3 distance</th><th>Stability TVD</th><th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {stageD.map((row) => (
            ...
            <figure className="system-interface-figure">
              <img
                src="/assets/systems/scenario-stress-lab/stress_lab_dashboard.png"
                alt="Multi-Asset Scenario Stress Lab practitioner interface showing current conditional stress structure beside the historical comparator."
              />
              <figcaption>
                Practitioner-facing Stress Lab surface. Scenario shares are generated
                frequencies within the modeled tail, not calibrated event probabilities.
              </figcaption>
            </figure>
          </section>
          ...
          <section className="prose-section" id="operation">
            ...
            <div className="system-operating-list">
              <div><strong>On-demand refresh.</strong><span> The system updates when the operator requests a current stress view; it is not a mandatory daily forecasting service.</span></div>
              <div><strong>Fail-closed issuance.</strong><span> Failed data or scenario-generation checks cannot appear as a successful current run.</span></div>
              ...
              <div><strong>Audit identity.</strong><span> Official runs preserve issue time, data-as-of, model configuration, seed policy, and output hashes for reconstruction and review.</span></div>
            </div>
          </section>
            ...
            <div className="system-boundary-grid">
              <div className="system-boundary-card allowed">
                ...
                <ul>
                  ...
                  <li>Model-implied tail/path diagnostics</li>
              ...
              <div className="system-boundary-card prohibited">
                ...
                <ul>
                  ...
                  <li>Causal macro/regime labels from archetype names</li>
          ...
          <section className="prose-section" id="documentation">
            ...
            <div className="repro-links documentation-artifacts">
              <a className="artifact" href={item.links.ssrn} target="_blank" rel="noopener noreferrer">
                <span className="artifact-kicker">SSRN</span>
                <strong>Technical White Paper</strong>
                <small>Public SSRN record · {item.ssrnId} · August 2026</small>
                <span className="artifact-action">Open SSRN ↗</span>
              </a>
              <a className="artifact" href={item.links.whitePaper}>
                <span className="artifact-kicker">PDF</span>
                <strong>White Paper PDF</strong>
                <small>System architecture, validation evidence, and operating boundaries</small>
                <span className="artifact-action">Open PDF →</span>
              </a>
            </div>
            <p className="body-copy documentation-note">
              A public Stress Lab dashboard will be linked here when its public-safe
              interface is released. Until then, the white paper is the primary public
              document for the system architecture, validation evidence, and operating
              boundaries.
            </p>
          </section>
          ...
          <section className="prose-section" id="citation">
            ...
            <div className="citation-box">
              Lee, S. (2026). Multi-Asset Scenario Stress Lab: Evidence-Constrained
              Scenario Analysis for Portfolio Stress Decision Support. Technical White
              Paper. SSRN 7354238.
            </div>
          </section>
        </article>
