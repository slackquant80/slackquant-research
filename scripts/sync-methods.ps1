...
$articleChecks = @(
  ...
  "60_MACHINE_LEARNING\QM019_REGULARIZED_LINEAR_MODELS\article.html",
  "60_MACHINE_LEARNING\QM020_TIME_SERIES_MODEL_SELECTION\article.html",
  "60_MACHINE_LEARNING\QM024_FORECAST_COMBINATION_MODEL_AVERAGING\article.html",
  "70_AI_FOUNDATION_MODELS\QM025_PRETRAINED_TIME_SERIES_FOUNDATION_MODELS\article.html",
  "80_DATA_RESEARCH_DESIGN\QM026_POINT_IN_TIME_DYNAMIC_UNIVERSE\article.html",
  "40_PORTFOLIO_METHODS\QM027_CROSS_SECTIONAL_RANKING_TOPK\article.html",
  "60_MACHINE_LEARNING\QM028_RL_ADAPTIVE_RISK_CONTROL\article.html",
  "40_PORTFOLIO_METHODS\QM029_DYNAMIC_CURRENCY_HEDGING\article.html"
)
