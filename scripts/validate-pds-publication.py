...
def main()->int:
    ...
    for tok in ['PDS_PUBLIC_DATA','Public dashboard','Overview','Core Performance','Portfolio History','Investor / FX','System & Disclosure','KRW Investor View','F2R 25% · ADAA 75%','Current asset targets','Monthly execution only · daily weights drift','<div class="brand-name">SlackQuant</div><div class="brand-sub">Systems</div>','pds-product-kicker','href="/systems/pds/"','href="/systems/adaa/"','href="/systems/f2r/"','Recent 12-Month Returns','PDS + Dynamic FX (5bp)','investor implementation first','portfolio-return-table','overflow-x:auto!important','public-table.portfolio-return-table','min-width:650px!important']:require(public_html,tok,'PDS standalone public dashboard',casefold=True)
