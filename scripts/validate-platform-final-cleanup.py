...
def main():
    ...
    for token in ["PDS_CANONICAL_PLATFORM_PAGE_V1","Reinforcement-Learning Adaptive Risk Control","Recent completed returns and four monitored portfolio views.","validated public operating view"]:
